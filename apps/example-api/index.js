...
app.get('/api/getTodos', async (req, res) => {
    ...
    console.log("hit /api/getTodos")
    res.json(resTodo);
})

/**
 * @type {get}
 * @summary api endpoint to get for healthcheck
*/
...
app.post('/api/updateTodo', async (req, res) => {
    ...
    console.log("hit /api/updateTodos")
...
app.post('/api/updateTodoisComplete', async (req, res) => {
    ...
    console.log("hit /api/updateTodoisComplete")
...
app.post('/api/deleteTodo', async (req, res) => {
    ...
    console.log("hit /api/deleteTodo")
